...
from_model = tf.keras.models.load_model('Gui/models/1200-elo/from.h5', compile=False)
to_model = tf.keras.models.load_model('Gui/models/1200-elo/to.h5', compile=False)
