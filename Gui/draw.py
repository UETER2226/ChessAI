...
wp = pygame.image.load('Gui/images/white_pawn.gif')
bp = pygame.image.load('Gui/images/black_pawn.gif')
wn = pygame.image.load('Gui/images/white_knight.gif')
bn = pygame.image.load('Gui/images/black_knight.gif')
wb = pygame.image.load('Gui/images/white_bishop.gif')
bb = pygame.image.load('Gui/images/black_bishop.gif')
wr = pygame.image.load('Gui/images/white_rook.gif')
br = pygame.image.load('Gui/images/black_rook.gif')
wq = pygame.image.load('Gui/images/white_queen.gif')
bq = pygame.image.load('Gui/images/black_queen.gif')
wk = pygame.image.load('Gui/images/white_king.gif')
bk = pygame.image.load('Gui/images/black_king.gif')

switch = pygame.image.load('Gui/images/switch.png')
switch = pygame.transform.scale(switch, (50, 60))

restart = pygame.image.load('Gui/images/restart.png')
